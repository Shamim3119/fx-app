...
namespace App\Filament\Resources\ReturnJournals;

use App\Filament\Resources\ReturnJournals\Pages\CreateReturnJournal;
use App\Filament\Resources\ReturnJournals\Pages\ListReturnJournals;
...
class ReturnJournalResource extends Resource
{
                                ...
                                Placeholder::make('vendor_recent_transactions')
                                    ...
                                    ->content(function (Get $get): HtmlString {
                                        ...
                                        $journals = Journal::query()
                                            ->where('type_id', self::TYPE_RETURN)
    ...
    public static function getPages(): array
    {
        return [
            ...
            'index' =>
                ListReturnJournals::route('/'),

            'create' =>
                CreateReturnJournal::route(
                    '/create'
                ),
